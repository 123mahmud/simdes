...
<article class="content">
   <div class="title-block text-primary">
      <h1 class="title"> Edit Data Pindah RT </h1>
      <p class="title-description">
         <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
         / <span>Master Data</span>
         / <a href="{{route('pindahrt')}}"><span>Data Pindah RT</span></a>
         / <span class="text-primary" style="font-weight: bold;">Edit Data Pindah RT</span>
      </p>
   </div>
   <form id="data">
               ...
               <div class="card">
                  <div class="card-header bordered p-2">
                     <div class="header-block">
                        <h3 class="title">Edit Data Pindah RT </h3>
                     </div>
                  ...
                  <div class="card-block">
                     <section>
                        <div class="row" id="myRow">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control currency-x" name="rt_tujuan" value="{{ $pindah_rt->rt_tujuan }}">
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control currency-x" name="rw_tujuan" value="{{ $pindah_rt->rw_tujuan }}">
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control datepicker" name="tgl_pindah" value="{{ date('d-m-Y', strtotime($pindah_rt->tgl_pindah)) }}">
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control" name="keterangan" value="{{ $pindah_rt->keterangan }}">
                              </div>
                           </div>
                  ...
                  <div class="card-footer text-right">
                     <button class="btn btn-primary btn-submit simpan" type="button" onclick="simpan('{{ Crypt::encrypt($pindah_rt->id) }}')">Update</button>
                  </div>
               </div>
            </div>
         </div>
