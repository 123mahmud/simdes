...
<article class="content">
   <div class="title-block text-primary">
      <h1 class="title"> Edit Data Kelahiran </h1>
      <p class="title-description">
         <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
         / <span>Master Data</span>
         / <a href="{{route('kelahiran')}}"><span>Data Kelahiran</span></a>
         / <span class="text-primary" style="font-weight: bold;">Edit Data Kelahiran</span>
      </p>
   </div>
   <form id="data">
               ...
               <div class="card">
                  <div class="card-header bordered p-2">
                     <div class="header-block">
                        <h3 class="title">Edit Data Kelahiran </h3>
                     </div>
                  ...
                  <div class="card-footer text-right">
                     <button class="btn btn-primary btn-submit simpan" type="button" onclick="simpan('{{ Crypt::encrypt($kelahiran->id) }}')">Update</button>
                  </div>
               </div>
            </div>
         </div>
