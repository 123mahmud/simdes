...
<article class="content">
   <div class="title-block text-primary">
      <h1 class="title"> Edit Data Kematian </h1>
      <p class="title-description">
         <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
         / <span>Master Data</span>
         / <a href="{{route('kematian')}}"><span>Data Kematian</span></a>
         / <span class="text-primary" style="font-weight: bold;">Edit Data Kematian</span>
      </p>
   </div>
   <form id="data">
               ...
               <div class="card">
                  <div class="card-header bordered p-2">
                     <div class="header-block">
                        <h3 class="title">Edit Data Kematian </h3>
                     </div>
                  ...
                  <div class="card-block">
                     <section>
                        <div class="row" id="myRow">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control" name="tempat_meninggal" value="{{ $kematian->tempat_meninggal }}">
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control" name="sebab_meninggal" value="{{ $kematian->sebab_meninggal }}">
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control datepicker" name="tanggal_meninggal" value="{{ date('d-m-Y', strtotime($kematian->tanggal_meninggal)) }}">
                              </div>
                           </div>
                  ...
                  <div class="card-footer text-right">
                     <button class="btn btn-primary btn-submit simpan" type="button" onclick="simpan('{{ Crypt::encrypt($kematian->id) }}')">Update</button>
                  </div>
               </div>
            </div>
         </div>
