         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="col-md-12 col-sm-12 col-xs-12 row" style="margin-top:10px;padding-bottom: 10px;padding-top: 20px;margin-bottom: 15px;">
                  ...
                  <div class="col-md-3 col-sm-12 col-xs-12">
                     <label class="tebal">Tempat Meninggal</label>
                  </div>
                  <div class="col-md-3 col-sm-12 col-xs-12">
                     <div class="form-group">
                        <label id="tempat_meninggal"></label>
                     </div>
                  </div>
                  <div id="append-modal-detail"></div>
                  <div class="col-md-3 col-sm-12 col-xs-12">
                     <label class="tebal">Sebab Meninggal</label>
                  </div>
                  <div class="col-md-3 col-sm-12 col-xs-12">
                     <div class="form-group">
                        <label id="sebab_meninggal"></label>
                     </div>
                  </div>
                  <div class="col-md-3 col-sm-12 col-xs-12">
                     <label class="tebal">Tanggal Meninggal</label>
                  </div>
                  <div class="col-md-3 col-sm-12 col-xs-12">
                     <div class="form-group">
                        <label id="tanggal_meninggal"></label>
                     </div>
                  </div>
                  <div id="append-modal-detail"></div>
               </div>
