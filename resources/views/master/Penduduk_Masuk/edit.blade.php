...
<article class="content">
   <div class="title-block text-primary">
      <h1 class="title"> Edit Data Penduduk Masuk </h1>
      <p class="title-description">
         <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
         / <span>Master Data</span>
         / <a href="{{route('penduduk')}}"><span>Data Penduduk Masuk</span></a>
         / <span class="text-primary" style="font-weight: bold;">Edit Data Penduduk Masuk</span>
      </p>
   </div>
   <form id="data">
               ...
               <div class="card">
                  <div class="card-header bordered p-2">
                     <div class="header-block">
                        <h3 class="title">Edit Data Penduduk Masuk </h3>
                     </div>
                  ...
                  <div class="card-block">
                     <section>
                        <div class="row" id="myRow">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control" name="alamat_asal" value="{{ $penduduk_masuk->alamat_asal }}">
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control currency-x" name="rt_asal" value="{{ $penduduk_masuk->rt_asal }}">
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control currency-x" name="rw_asal" value="{{ $penduduk_masuk->rw_asal }}">
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="hidden" class="form-control-sm form-control ui-autocomplete" name="kecamatan_asal" value="{{ $kec->id }}">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="hidden" class="form-control-sm form-control" readonly="" name="kabupaten_asal" value="{{ $kab->id }}">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="hidden" class="form-control-sm form-control" readonly="" name="provinsi_asal" value="{{ $pro->id }}">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control datepicker" name="tgl_pindah" value="{{ date('d-m-Y', strtotime($penduduk_masuk->tgl_pindah)) }}">
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6 col-xs-12">
                           ...
                           <div class="col-md-3 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 <input type="text" class="form-control-sm form-control" name="keterangan" value="{{ $penduduk_masuk->keterangan }}">
                              </div>
                           </div>
                  ...
                  <div class="card-footer text-right">
                     <button class="btn btn-primary btn-submit simpan" type="button" onclick="simpan('{{ Crypt::encrypt($penduduk_masuk->id) }}')">Update</button>
                  </div>
               </div>
            </div>
         </div>
