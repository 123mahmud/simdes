        ...
        <ul class="sidebar-menu metismenu" id="sidebar-menu">
            ...
            <li class="{{Request::is('master/*') ? 'active open' : ''}}">
                <a href="#">
                    ...
                    <!-- Filter Menu Submenu -->
                    <span class="d-none">
                        @if(Auth::user()->punyaAkses('Jabatan','ma_read'))
                        Jabatan
                        @endif
                        @if(Auth::user()->punyaAkses('Pegawai Desa','ma_read'))
                        Pegawai Desa
                        @endif
                        @if(Auth::user()->punyaAkses('Penduduk','ma_read'))
                        Penduduk
                        @endif
                        @if(Auth::user()->punyaAkses('Kelahiran','ma_read'))
                        Kelahiran
                        @endif
                        @if(Auth::user()->punyaAkses('Kematian','ma_read'))
                        Kematian
                        @endif
                        @if(Auth::user()->punyaAkses('Penduduk Masuk','ma_read'))
                        Penduduk Masuk
                        @endif
                        @if(Auth::user()->punyaAkses('Penduduk Keluar','ma_read'))
                        Penduduk Keluar
                        @endif
                        @if(Auth::user()->punyaAkses('Penduduk Pindah RT','ma_read'))
                        Penduduk Pindah RT
                        @endif
                    </span>
            ...
            @endif
            @if(Auth::user()->punyaAkses('Pembuatan','ma_read'))
            <li class="{{Request::is('pembuatan/*') ? 'active open' : ''}}">
                <a href="#">
                    ...
                    <i class="fa arrow"></i>
                    <span class="d-none">
                        @if(Auth::user()->punyaAkses('Surat','ma_read'))
                        Surat
                        @endif
                        @if(Auth::user()->punyaAkses('Laporan','ma_read'))
                        Laporan
                        @endif
                    </span>
                </a>
            ...
            @endif
            @if(Auth::user()->punyaAkses('Data Referensi','ma_read'))
            <li class="{{Request::is('reff/*') ? 'active open' : ''}}">
                <a href="#">
                    ...
                    <i class="fa arrow"></i>
                    <span class="d-none">
                        @if(Auth::user()->punyaAkses('Reff Kode Surat','ma_read'))
                        Reff Kode Surat
                        @endif
                        @if(Auth::user()->punyaAkses('Reff Pekerjaan','ma_read'))
                        Reff Pekerjaan
                        @endif
                    </span>
                </a>
            ...
            @endif
            @if(Auth::user()->punyaAkses('Admin System','ma_read'))
