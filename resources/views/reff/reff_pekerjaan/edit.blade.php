...
<article class="content">
   ...
   <div class="title-block text-primary">
      <h1 class="title"> Edit Data Pekerjaan </h1>
      <p class="title-description">
        <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
         / <span>Master Data</span>
         / <a href="{{route('rpekerjaan')}}"><span>Data Satuan</span></a>
         / <span class="text-primary" style="font-weight: bold;">Edit Data Pekerjaan</span>
       </p>
   </div>
            ...
            <div class="card">
               <div class="card-header bordered p-2">
                  <div class="header-block">
                     <h3 class="title">Edit Data Pekerjaan</h3>
                  </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-9 col-sm-8 col-xs-12">
                           <div class="form-group">
                              <input type="text" class="form-control form-control-sm" name="nama" value="{{ $pekerjaan->nama }}">
                           </div>
                        </div>
                     </div>
                     </form>
...
<script type="text/javascript">
   ...
   function simpan()
   {
      ...
      $.ajax({
         url: '{{ url("rpekerjaan/update") }}' + '/' + {{ $pekerjaan->id }},
         type: 'POST',
         data: $('#form').serialize(),
