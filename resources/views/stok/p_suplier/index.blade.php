...
<article class="content">
    <div class="title-block text-primary">
        <h1 class="title"> Penerimaan Barang Supplier </h1>
        <p class="title-description">
            <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
            / <span>Stok</span>
            / <span class="text-primary font-weight-bold">Penerimaan Barang Supplier</span>
        </p>
    </div>
    ...
    $('#head_nota_purchase').change(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.data_header[0].d_pcs_method == "DEPOSIT") {
                    ...
                    $('#appending').append('<div class="form-group">' +
                        '<input type="hidden" id="apd_tgl" name="apdTgl" class="form-control datepicker3 input-sm form-control-sm" readonly value="' + newDueDate + '">' +
                        '</div>');
                ...
                Object.keys(data.data_isi).forEach(function() {
                    ...
                    $('#tabel-modal-terima').append('<tr class="tbl_form_row" id="row' + i + '">' +
                        ...
                        '<td><input type="text" value="' + data.data_isi[key - 1].i_code + ' | ' + data.data_isi[key - 1].i_name + '" name="fieldNamaItem[]" class="form-control input-sm form-control-sm" readonly/>' +
                        '<input type="hidden" value="' + data.data_isi[key - 1].i_id + '" name="fieldItemId[]" class="form-control input-sm form-control-sm"/>' +
                        '<input type="hidden" value="' + data.data_isi[key - 1].d_pcsdt_id + '" name="fieldIdPurchaseDet[]" class="form-control input-sm form-control-sm"/></td>' +
                        '<td><input type="text" value="' + qtyCost + '" name="fieldQty[]" class="form-control numberinput input-sm form-control-sm field_qty" readonly/></td>' +
                        '<td><input type="text" value="' + qtyTerima + '" name="fieldQtyterima[]" class="form-control numberinput input-sm form-control-sm field_qty_terima" id="' + i + '"/>' +
                        '<input type="hidden" value="' + qtyTerima + '" name="fieldQtyterimaHidden[]" class="form-control numberinput input-sm form-control-sm" id="qtymskhidden_' + i + '"/></td>' +
                        '<td><input type="text" value="' + data.data_isi[key - 1].s_name + '" name="fieldSatuanTxt[]" class="form-control input-sm form-control-sm" readonly/>' +
                        ...
                        '<input type="hidden" value="' + hargaTotalPerRow + '" name="fieldHargaTotalRaw[]" id="totalRaw_' + i + '" class="form-control input-sm form-control-sm field_hargatotal_raw numberinput" readonly/></td>' +
                        '<td><input type="text" value="' + data.data_stok[key - 1].qtyStok + ' ' + data.data_satuan[key - 1] + '" name="fieldStokTxt[]" class="form-control input-sm form-control-sm" readonly/>' +
                        '<input type="hidden" value="' + data.data_stok[key - 1].qtyStok + '" name="fieldStokVal[]" class="form-control input-sm form-control-sm" readonly/></td>' +
            ...
            error: function() {
                $.toast({
                    heading: '',
                    text: 'Data dengan nomor PO tersebut tidak ada yang bertipe BJ',
